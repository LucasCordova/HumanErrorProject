...
namespace HumanErrorProject.Ui.Pages.Analysis
{
    ...
    public class StudentBagOfWordsModel : PageModel
    {
        public HumanErrorProjectContext Context;
        public DbSet<Assignment> Assignments;

        public StudentBagOfWordsModel(HumanErrorProjectContext context)
        {
            Context = context;
        ...
        public BagOfWordsMetric GetLeastCodeAnalysisMetricOrDefault(List<Snapshot> snapshots,
            MethodDeclaration method)
        {
            ...
            return declaredMethods.OrderBy(x => x.CodeAnalysisMetric.BagOfWordsMetric.Difference)
                .First().CodeAnalysisMetric.BagOfWordsMetric;
        }

        public BagOfWordsMetric GetLatestCodeAnalysisMetricOrDefault(List<Snapshot> snapshots, MethodDeclaration method)
        {
            ...
            return !declared.Declared ? null : declared.CodeAnalysisMetric.BagOfWordsMetric;
        }
    }
}